...
public class ToyotaRav4 extends Car {
    ...
    ToyotaRav4(String colour, String transmission, int currentSpeed, int price, int length, int weigth, int mileage) {
        super(colour, transmission, currentSpeed, price);
        this.colour = colour;
        this.maxSpeed = 200;//фиксированная макс скорость
