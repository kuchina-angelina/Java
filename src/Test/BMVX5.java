...
public class BMVX5 extends Car{
    int length,weigth,mileage; //длина,ширина,пробег
    String seatHeating;//подогрев сиденья
    int maxSpeed;//максимальная скорость

    BMVX5(String colour,String transmission,int currentSpeed,int price,int length,int weigth, int mileage){
        super(colour,transmission,currentSpeed,price);
        this.colour = colour;
        this.maxSpeed = 225;//фиксированная максимальная скорость
        ...
        this.weigth = weigth;
        this.length = length;
        this.seatHeating = "Yes";//наличие функции подогрева сиденья
    }
